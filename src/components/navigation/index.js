                ...
                <nav className="bg-white border-gray-200 dark:bg-slate-800">
                    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Coderhub</span>
                        </Link>
                        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                            ...
                            <div className={`relative ${!isMenuOpen ? 'hidden' : ''}`}>
                                <div className="z-50 absolute my-4 text-base list-none bg-gray-2 dark:bg-slate-500 divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                                    ...
                                    <ul className="py-2" onClick={()=>setMenuOpen(false)} aria-labelledby="user-menu-button">
                                        {
                            ...
                            <button
                              onClick={()=>setOpenSideManus(!openSideManue)} 
                              type="button" 
                        ...
                        <div className={`${openSideManue ? '': 'hidden'} items-center justify-between w-full md:flex md:w-auto md:order-1`} >
                            <ul
                              onClick={()=> setOpenSideManus(false)}
                              className="flex flex-col font-medium p-4 md:p-0 mt-4 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 ">
                                <li>
