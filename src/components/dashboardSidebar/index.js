...
export default function Sidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    return (
        <aside
            ref={sidebar}
            className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-slate-400 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                }`}
        >
            <div className="flex dark:bg-slate-600 items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 pt-5">
                <Link href="/">
                    <Image
                        width={45}
                        height={45}
            ...
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
                    <div>
                        <h3 className="mb-4 ml-4 text-sm font-semibold text-stone-700 dark:text-bodydark2">
                            MENU
                        </h3>
                        ...
                        <ul className="mb-6 flex flex-col gap-1.5">
                            <li>
                                <Link
                                    ...
                                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-slate-800 dark:text-bodydark1 duration-300 ease-in-out hover:bg-slate-300 dark:hover:bg-meta-4 ${(pathname === "/agency/dashboard" ||
                            ...
                            <li>
                                <Link
                                    href="/profile"
                                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-slate-800 dark:text-bodydark1 duration-300 ease-in-out hover:bg-slate-300 dark:hover:bg-meta-4 ${pathname.includes("profile") && "bg-slate-300 dark:bg-meta-4"
                                        }`}
                                >
                                    <svg
                                        className="fill-current"
                                        ...
                                        <React.Fragment>
                                            ...
                                            permissions.data.includes('users') ?
                                                    <div>
                                                        <Link
                                                            href="/users/role"
                                                            className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium  text-slate-800  dark:text-bodydark1 duration-300 ease-in-out hover:bg-slate-300 dark:hover:bg-meta-4 ${(pathname.includes("users") ||
                                                                pathname.includes("roles") || pathname.includes('mapings') || pathname.includes('components')) &&
                                                                "bg-slate-300 dark:bg-meta-4"
                                                                }`}
                                                            onClick={(e) => {
                                                                e.preventDefault();
                                                        ...
                                                        >
                                                            <FaUserLock className="text-current" />
                            ...
                            {
                                permissions.data.includes('settings') ?
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-1.5">
                            ...
                            <SidebarLinkGroup
                                activeCondition={
                                    pathname === "/agency/dashboard/services"
                                    || pathname === "/agency/dashboard/categories"}
                            >
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <Link
                                                href="#"
                                                className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-stone-800 dark:text-bodydark1 duration-300 ease-in-out hover:bg-slate-300  dark:hover:bg-meta-4 ${(pathname === "/agency/dashboard/categories" || pathname.includes("/agency/dashboard/categories")) &&
                                                    "bg-slate-300 dark:bg-meta-4"
                                                    }`}
                                                onClick={(e) => {
                                                    e.preventDefault();
                                            ...
                                            >
                                                <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                                       ...
                                                       permissions.data.includes('services') ?
                                                            <li>
                                                                <Link
                                                                    ...
                                                                    className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out text-stone-800 dark:text-bodydark1 hover:bg-slate-300 dark:hover:bg-meta-4${pathname === "/agency/dashboard/services" && "bg-slate-300 dark:bg-meta-4"
                                                                        }`}
                                                                >
                                                                    service
                                                                </Link>
                                                    ...
                                                    {
                                                        permissions.data.includes('categories') ?
                                                            <li>
                                                                <Link
                                                                    href="/agency/dashboard/categories"
                                                                    className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-stone-800 dark:text-bodydark1 duration-300 ease-in-out hover:bg-slate-300 dark:hover:bg-meta-4${pathname === "/agency/dashboard/categories" && "bg-slate-300 dark:bg-meta-4"
                                                                        }`}
                                                                >
                                                                    category
                                                                </Link>
                    ...
                    {
                        permissions.data.includes('proposals') ?
                            <div>
                                <ul className="flex flex-col gap-1.5">
                                    <li>
                                        <Link
                                            href="/agency/dashboard/proposals"
                                            className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-stone-800 dark:text-bodydark1 duration-300 ease-in-out hover:bg-slate-300 dark:hover:bg-meta-4 ${pathname.includes("proposals") &&
                                                "bg-slate-300 dark:bg-meta-4"
                                                }`}
                                        >
                    ...
                    {
                        permissions.data.includes('transactions') ?
                            <div>
                                <ul className="flex flex-col gap-1.5">
                                    <li>
                                        <Link
                                            href="/agency/dashboard/transactions"
                                            className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium  duration-300 ease-in-out text-stone-800 dark:text-bodydark1 hover:bg-slate-300 dark:hover:bg-meta-4 ${pathname.includes("transactions") &&
                                                "bg-slate-300 dark:bg-meta-4"
                                                }`}
                                        >
