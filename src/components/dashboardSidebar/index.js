...
export default function Sidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 pt-5">
                <Link href="/">
                    <Image
                        width={45}
                        height={45}
                            ...
                            >
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            {
                                                permissions.data.includes(pathname.split('/').pop()) ?
                                                    <div>
                                                        <Link
                                                            href="/users/role"
                                                            ...
                                                            <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                                                ...
                                                                <li>
                                                                    <Link
                                                                        ...
                                                                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/agency/dashboard/roles" &&
                                                                            "text-white"
                                                                            } `}
                                                                    >
                                                                        Role
                                                                ...
                                                                <li>
                                                                    <Link
                                                                        ...
                                                                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/agency/dashboard/components" &&
                                                                            "text-white"
                                                                            } `}
                                                                    >
                                                                        Component
                                                                ...
                                                                <li>
                                                                    <Link
                                                                        ...
                                                                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/agency/dashboard/mapings" &&
                                                                            "text-white"
                                                                            } `}
                                                                    >
                                                                        RC Maping
