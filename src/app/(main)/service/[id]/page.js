...
function servicePage(props) {
  ...
  return (
    <>
      <div class=" flex bg-orange-100 rounded-lg shadow-lg h-125">
        <div className='left w-1/2  text-left mt-20'>
          <div class=" items-center mb-6 ml-40">
            ...
            <h3 class="text-xl font-semibold  text-slate-950 mt-5">Service Name</h3>
            <p class=" text-slate-950 mt-5">Service Category</p>
          ...
          <Image className='w-150 ' src={service_img} alt="Service Image" class="" />
